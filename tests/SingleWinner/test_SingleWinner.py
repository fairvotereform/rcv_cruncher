...
@pytest.mark.parametrize("param", params)
def test_win_threshold(param):
    rcv = SingleWinner(**param['input'])
    assert rcv.stats()[0]['win_threshold'].item() == param['expected']['stat']
...
@pytest.mark.parametrize("param", params)
def test_number_of_winners(param):
    rcv = SingleWinner(**param['input'])
    assert rcv.stats()[0]['number_of_winners'].item() == param['expected']['stat']
