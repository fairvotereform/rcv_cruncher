...
def test_first_round_winner_vote(param):
    rcv = Sequential(**param['input'])
    assert [i['first_round_winner_vote'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_final_round_winner_vote(param):
    rcv = Sequential(**param['input'])
    assert [i['final_round_winner_vote'].item() for i in rcv.stats()] == param['expected']['stat']
...
params = [
    ...
    ({
        ...
        'expected': {
            'stat': [round(100 * 5/15, 3), round(100 * 3/10, 3)]
        }
    }),
    ({
        'input': {
        ...
        'expected': {
            'stat': [round(100 * 5/15, 3), round(100 * 3/10, 3), round(100 * 7/10, 3)]
        }
    })
]
...
def test_first_round_winner_percent(param):
    rcv = Sequential(**param['input'])
    assert [i['first_round_winner_percent'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_final_round_winner_percent(param):
    rcv = Sequential(**param['input'])
    assert [i['final_round_winner_percent'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_first_round_winner_place(param):
    rcv = Sequential(**param['input'])
    assert [i['first_round_winner_place'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_condorcet(param):
    rcv = Sequential(**param['input'])
    assert [i['condorcet'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_come_from_behind(param):
    rcv = Sequential(**param['input'])
    assert [i['come_from_behind'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_ranked_winner(param):
    rcv = Sequential(**param['input'])
    assert [i['ranked_winner'].item() for i in rcv.stats()] == param['expected']['stat']
...
params = [
    ...
    ({
        ...
        'expected': {
            'stat': [round(100 * 8/15, 3), round(100 * 6/10, 3)]
        }
    }),
    ({
        'input': {
        ...
        'expected': {
            'stat': [round(100 * 8/15, 3), round(100 * 6/10, 3), round(100 * 7/10, 3)]
        }
    })
]
...
def test_final_round_winner_votes_over_first_round_active(param):
    rcv = Sequential(**param['input'])
    assert [i['final_round_winner_votes_over_first_round_active'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_static_win_threshold(param):
    rcv = Sequential(**param['input'])
    assert [i['static_win_threshold'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_number_of_tabulation_winners(param):
    rcv = Sequential(**param['input'])
    assert [i['number_of_tabulation_winners'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_number_of_contest_winners(param):
    rcv = Sequential(**param['input'])
    assert [i['number_of_contest_winners'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_winner(param):
    rcv = Sequential(**param['input'])
    assert [i['winner'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_winners_consensus_value(param):
    rcv = Sequential(**param['input'])
    assert [i['winners_consensus_value'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_first_round_active_votes(param):
    rcv = Sequential(**param['input'])
    assert [i['first_round_active_votes'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_final_round_active_votes(param):
    rcv = Sequential(**param['input'])
    assert [i['final_round_active_votes'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_total_pretally_exhausted(param):
    rcv = Sequential(**param['input'])
    assert [i['total_pretally_exhausted'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_total_posttally_exhausted_by_overvote(param):
    rcv = Sequential(**param['input'])
    assert [i['total_posttally_exhausted_by_overvote'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_total_posttally_exhausted_by_skipped_rankings(param):
    rcv = Sequential(**param['input'])
    assert [i['total_posttally_exhausted_by_skipped_rankings'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_total_posttally_exhausted_by_abstention(param):
    rcv = Sequential(**param['input'])
    assert [i['total_posttally_exhausted_by_abstention'].item() for i in rcv.stats()] == param['expected']['stat']
...
def test_total_posttally_exhausted_by_rank_limit(param):
    rcv = Sequential(**param['input'])
    assert [i['total_posttally_exhausted_by_rank_limit'].item() for i in rcv.stats()] == param['expected']['stat']
